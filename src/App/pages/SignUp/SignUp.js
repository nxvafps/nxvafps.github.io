        ...
        <div>
            ...
            {isSubmitted ? (
                <div className={styles.successMessage}>
                    <p>We have sent you an email with a link to confirm your account. If you have received this, you can close this page. Otherwise, click the button below to send another confirmation link.</p>
                    <button className={styles.button} onClick={signUp}>Resend Confirmation Link</button>
                </div>
            ) : (
